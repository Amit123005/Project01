...
import PartNameData from "./partName";
import ModelData from "./model";
import LineSpeedData from "./lineSpeed";
import FactorData from "./factor";
import { LocalizationProvider } from '@mui/x-date-pickers/LocalizationProvider';
import { DateRangePicker } from '@mui/x-date-pickers-pro/DateRangePicker';
import { AdapterDayjs } from '@mui/x-date-pickers/AdapterDayjs';
import dayjs from "dayjs";
import Process_params from "./process_params";
import Line_Speed_Trend from "./line_speed_trend";
import Barrel_Zone_Trend from "./barrel_zone_trend";
import Die_Zone_Trend from "./die_zone_trend";
import Factor_Trend from "./factor_trend";
import Main_Motor_TrendE1 from "./main_motor_trende1";
  ...
  return (
    ...
    <Box m="20px 0 0 80px">
      <Box display="flex" justifyContent="space-between" alignItems="center" flexDirection={isSmallScreen ? "column" : "row"}>
        <Header title="Extruder 1" subtitle="Process Quality Parameters Dashboard" />
      ...
      >
      <Box mb="25px" display="flex" alignItems="center" gap="10px">
      ...
      >
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Barrel_Zone_Trend dateRange={dateRange} shift={shift} area={area} barrelZoneFilter={barrelzone}/>
          </Box>
        </Box>
        <Box
          gridColumn={isSmallScreen ? "span 8" : "span 12"}
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Die_Zone_Trend dateRange={dateRange} shift={shift} area={area} dieZoneFilter={diezone}/>
          </Box>
        </Box>
        <Box
          gridColumn={isSmallScreen ? "span 8" : "span 12"}
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Main_Motor_TrendE1 dateRange={dateRange} shift={shift} area={area}/>
          </Box>
        </Box>
      </Box>
    </Box>
