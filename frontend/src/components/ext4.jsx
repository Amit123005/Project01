...
import Barrel_Zone_TrendE4 from "./barrel_zone_trendE4";
import Die_Zone_TrendE4 from "./die_zone_trendE4";
import Factor_TrendE4 from "./factor_trendE4";
import Main_Motor_TrendE4 from "./main_motor_trendE4";
  ...
  return (
    ...
    <Box m="20px 0 0 80px">
      ...
      <Box display="flex" justifyContent="space-between" alignItems="center" flexDirection={isSmallScreen ? "column" : "row"}>
        <Header title="Extruder 4" subtitle="Process Quality Parameters Dashboard" />
      ...
      >
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Barrel_Zone_TrendE4 dateRange={dateRange} shift={shift} area={area} barrelZoneFilter={barrelzone}/>
          </Box>
        </Box>
        <Box
          gridColumn={isSmallScreen ? "span 8" : "span 12"}
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Die_Zone_TrendE4 dateRange={dateRange} shift={shift} area={area} dieZoneFilter={diezone}/>
          </Box>
        </Box>
        <Box
          gridColumn={isSmallScreen ? "span 8" : "span 12"}
        ...
        >
          ...
          <Box height="70%" m="20px 0 0 0" width="100%">
            <Main_Motor_TrendE4 dateRange={dateRange} shift={shift} area={area}/>
          </Box>
        </Box>
      </Box>
    </Box>
