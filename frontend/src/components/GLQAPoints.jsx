...
export default function GLQAPoints() {
  ...
  const handleSubmitStatus = async () => {
    ...
    try {
      const res = await fetch(`http://163.125.102.142:5000/api/gl_qa_points/${selectedRow.id}`, {
  ...
  const fetchData = async () => {
    let url = "http://163.125.102.142:5000/api/gl_qa_points?";
